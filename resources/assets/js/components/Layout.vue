...
export default class extends React.PureComponent {
    ...
    tabData = [
        ...
        {title: '分类', href: '/category', icon: svgs[1], icon2: svgs2[1]},
        {title: '发现', href: '/discover', icon: svgs[1], icon2: svgs2[1]},
        {title: '购物车', href: '/cart', icon: svgs[2], icon2: svgs2[2]},
        {title: '我的', href: '/user', icon: svgs[3], icon2: svgs2[3]},
    ];
                            ...
                            renderTab={tab => (
                                <div className={styles.tab}>
                                    ...
                                    <div
                                        ...
                                        style={{
                                            color: this.isActive(tab.href) ? '#f23030' : '',
                                        }}
                                    >
                                        {tab.title}
                                    </div>
