...
require(ROOT_PATH . 'include/base/config/inc_constant.php');
...
/* 初始化session */
require(ROOT_PATH . 'include/base/classes/cls_session.php');
...
{
    include(ROOT_PATH . 'include/base/classes/cls_captcha.php');
...
if (!file_exists('../data/caches/caches'))
{
    @mkdir('../data/caches/caches', 0777);
    @chmod('../data/caches/caches', 0777);
}
...
defined('__TPL__') OR define('__TPL__', __PUBLIC__ . '/admin');
