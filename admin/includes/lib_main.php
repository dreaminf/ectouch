...
function create_html_editor($input_name, $input_value = '')
{
    ...
    $FCKeditor = '<input type="hidden" id="'.$input_name.'" name="'.$input_name.'" value="'.htmlspecialchars($input_value).'" /><iframe id="'.$input_name.'_frame" src="../plugins/ueditor/ecmobanEditor.php?item='.$input_name.'" width="824" height="480" frameborder="0" scrolling="no"></iframe>';
