...
defined('RELEASE') or define('RELEASE', '20160301');
...
defined('COMMON_PATH') or define('COMMON_PATH', APP_PATH . 'base/');
...
defined('BIND_ECSHOP') or define('BIND_ECSHOP', (int)file_exists(dirname(ROOT_PATH) . '/data/config.php'));
defined('BIND_MODULE') or define('BIND_MODULE', 'site');
// 启动应用
require BASE_PATH . 'system/autoload.php';
