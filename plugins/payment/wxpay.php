...
$payment_lang = ROOT_PATH . 'language/' .C('lang'). '/payment/wxpay.php';
...
class Wxpay implements PaymentInterface
{
    ...
    public function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><button class="btn btn-primary" type="button" onclick="callpay()">微信支付</button></div>' . $js;
