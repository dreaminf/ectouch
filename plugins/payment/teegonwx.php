...
class teegonwx
{
    ...
    public function get_code($order, $payment)
    {
       ...
       // $param['return_url'] = 'http://www.qq.com';
        ...
        $param['client_id'] = $payment['teegonwx_client_id'];
...
//        error_log(print_r($param,1)."\n~~~~",3,"/Users/roshan/www/ecshop/admin/ecshop.log");
        ...
        $def_url  = '<div style="text-align:center"><form name="teegonwx" accept-charset="UTF-8" style="text-align:center;" method="post" action="https://api.teegon.com/charge/pay" target="_blank">';
       ...
       // echo "<pre/>";
        ...
        if ($_GET['is_success'] == 'true')
        {
            ...
            order_paid($pay_id, 2);
                ...
                $tgsign = md5($tgreturn.$payment['teegonwx_client_secret']);
...
//teegonwx 加密算法
    public function sign($para_temp,$payment){
        ...
        $prestr = $payment['teegonwx_client_secret'] .$prestr . $payment['teegonwx_client_secret'];
