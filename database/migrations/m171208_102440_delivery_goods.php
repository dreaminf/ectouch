    ...
    public function safeUp()
    {
        ...
        $this->createTable(
            ...
            [
                ...
                'delivery_id'=> $this->integer(10)->unsigned()->notNull()->defaultValue('0'),
                'goods_id'=> $this->integer(10)->unsigned()->notNull()->defaultValue('0'),
                'product_id'=> $this->integer(10)->unsigned()->null()->defaultValue('0'),
                ...
                'parent_id'=> $this->integer(10)->unsigned()->null()->defaultValue('0'),
                'send_number'=> $this->integer(10)->unsigned()->null()->defaultValue(0),
