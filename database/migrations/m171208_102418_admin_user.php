    ...
    public function safeUp()
    {
        ...
        $this->createTable(
            ...
            [
                ...
                'last_login'=> $this->integer(10)->notNull()->defaultValue(0),
                ...
                'suppliers_id'=> $this->integer(10)->unsigned()->null()->defaultValue(0),
                'todolist'=> $this->text()->null()->defaultValue(null),
                'role_id'=> $this->integer(10)->null()->defaultValue(null),
            ],$tableOptions
        );
