...
class Brand extends IndexController {
    ...
    public function index() {
        ...
        $count = get_brands_count();
        $this->pageLimit(url('index'), $this->size);
        $this->assign('pager', $this->pageShow($count));
        
        $list = get_brands('brand', $this->size, $this->page);
    ...
    public function goods_list() {
        ...
        $this->assign('cat', $cat);
        $goods_list = brand_get_goods($brand_id, '', $this->sort, $this->order, $this->size, $this->page);
        $this->assign('goods_list', $goods_list);
        $count = goods_count_by_brand($brand_id, $this->cat);
    ...
    public function list_asynclist() {
        ...
        $this->size = I('post.amount');
        $this->page = ($asyn_last > 0) ? ceil($asyn_last / $this->size) : 1;
        $list = brand_get_goods($brand_id, '', $this->sort, $this->order, $this->size, $this->page);
        foreach ($list as $key => $value) {
