...
CREATE TABLE IF NOT EXISTS `ecs_touch_nav` (
  ...
  `ifshow` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `vieworder` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `opennew` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ecs_drp_profit` (
  `profit_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类利润id',
  `cate_id` int(10) unsigned DEFAULT '0' COMMENT '商品分类',
...
CREATE TABLE IF NOT EXISTS `ecs_drp_shop` (
  `id` int(10) unsigned AUTO_INCREMENT COMMENT '店铺id',
  ...
  `audit` int(1) unsigned NOT NULL DEFAULT '0' COMMENT '店铺是否审核',
  `open` int(1) unsigned NOT NULL DEFAULT '0' COMMENT '店铺是否开启',
  `bank` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '默认银行卡',
...
CREATE TABLE IF NOT EXISTS `ecs_drp_order_info` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `drp_id` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ecs_drp_apply` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `apply` int(1) unsigned DEFAULT '1',
  `user_id` int(10) unsigned DEFAULT '0',
  `time` int(12) unsigned DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ecs_team_log` (
  ...
  `start_time` int(10) unsigned COMMENT '开团时间',
  `status` tinyint(10) unsigned NOT NULL DEFAULT '0' COMMENT '拼团状态（1成功，2失败）',
...
CREATE TABLE IF NOT EXISTS `ecs_team_category` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '频道id',
  ...
  `status` tinyint(10) unsigned NOT NULL DEFAULT '1' COMMENT '显示0否 1显示',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ;
...
CREATE TABLE IF NOT EXISTS `ecs_crowd_article` (
  `article_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id号',
  `title` varchar(120) NOT NULL COMMENT '标题',
  `description` text COMMENT '评论内容',
  `add_time` int(10) DEFAULT NULL COMMENT '添加时间',
  `sort_order` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `is_open` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '显示 1是  0否',
...
CREATE TABLE IF NOT EXISTS `ecs_crowd_category` (
  `cat_id` mediumint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '众筹分类id',
  `cat_name` varchar(90) DEFAULT NULL COMMENT '分类名称',
  `cat_desc` varchar(255) DEFAULT NULL COMMENT '分类描述',
  `parent_id` mediumint(5) unsigned NOT NULL DEFAULT '0' COMMENT '父分类id',
  `sort_order` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `is_show` int(1) unsigned NOT NULL DEFAULT '0' COMMENT '显示 0 否 1显示',
  PRIMARY KEY (`cat_id`)
...
CREATE TABLE IF NOT EXISTS `ecs_crowd_comment` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论id号',
  ...
  `add_time` int(10) unsigned DEFAULT NULL COMMENT '评论时间',
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '显示 1是  0否',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
