    ...
    if ($filename != 'index')
    {
        ...
        else
        {
            ...
            if ('group_buy' == $filename)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= ' <code>&gt;</code> <a href="'. U('groupbuy/index/index') .'">' .
            ...
            elseif ('auction' == $filename)
            {
                ...
                $args       = array('auid' => '0');
                $ur_here   .= ' <code>&gt;</code> <a href="'. U('auction/index/index') .'">' .
            ...
            elseif ('snatch' == $filename)
            {
                ...
                $args       = array('id' => '0');
                $ur_here   .= ' <code> &gt; </code><a href="'. U('snatch/index/index') .'">' .                                 
            ...
            elseif ('wholesale' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <code>&gt;</code> <a href="'. U('wholesale/index/index') .'">' .
            ...
            elseif ('exchange' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <code>&gt;</code> <a href="'. U('exchange/index/index') .'">' .
