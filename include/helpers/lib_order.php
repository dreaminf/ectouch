...
function shipping_fee($shipping_code, $shipping_config, $goods_weight, $goods_amount, $goods_number='')
{
    ...
    $filename = ROOT_PATH . 'source/modules/shipping/' . $shipping_code . '.php';
...
function shipping_insure_fee($shipping_code, $goods_amount, $insure)
{
    ...
    {
        $path = ROOT_PATH . 'source/modules/shipping/' . $shipping_code . '.php';
...
function available_payment_list($support_cod, $cod_fee = 0, $is_online = false)
{
    ...
    include_once(ROOT_PATH.'source/helpers/lib_compositor.php');
...
function merge_order($from_order_sn, $to_order_sn)
{
    ...
    include_once(ROOT_PATH . 'soucre/helpers/lib_clips.php');
    /* 插入支付日志 */
...
function &get_shipping_object($shipping_id)
{
    ...
    $file_path = ROOT_PATH.'source/modules/shipping/' . $shipping['shipping_code'] . '.php';
...
function integral_to_give($order)
{
    ...
    if ($order['extension_code'] == 'group_buy')
    {
        include_once(ROOT_PATH . 'source/helpers/lib_goods.php');
