...
class Flow extends IndexController {
    ...
    public function cart() {
        ...
        //取得购物车中基本件ID
        $sql = "SELECT goods_id " .
                "FROM " . $this->load->ecs->table('cart') .
                " WHERE session_id = '" . SESS_ID . "' " .
                "AND rec_type = '" . CART_GENERAL_GOODS . "' " .
                "AND is_gift = 0 " .
                "AND extension_code <> 'package_buy' " .
                "AND parent_id = 0 ";
        $parent_list = $this->load->db->getCol($sql);
