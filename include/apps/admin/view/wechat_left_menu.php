<div class="list-group">
	<a class="list-group-item disabled"><span class="glyphicon glyphicon-th-large"></span> 设置</a>
	<a class="list-group-item {if $action == 'modify'}active{/if}" href="{url('wechat/modify')}">配置公众号</a>
