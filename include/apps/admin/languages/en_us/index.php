 ...
 * File name：index.php
 * ----------------------------------------------------------------------------
 * Function description：Control panel start page language file
 * ----------------------------------------------------------------------------
 * Licensed ( http://www.ectouch.cn/docs/license.txt )
 * ----------------------------------------------------------------------------
 */
$_LANG['label_username'] = 'Administrator user name：';
$_LANG['label_password'] = 'Administrator password：';
$_LANG['label_email'] = 'Administrator email：';
$_LANG['label_captcha'] = 'Verification Code:';
$_LANG['click_for_another'] = 'Can\'t see clearly? Click replace another authentication code。';
$_LANG['signin_now'] = 'Enter management center';
$_LANG['remember'] = 'Please save my login information this time.';

$_LANG['back_home'] = 'Return home';
$_LANG['forget_pwd'] = 'Did you forget the password?';
$_LANG['get_new_pwd'] = 'Retrieve password';
$_LANG['goto_login'] = 'Return to continue logon';

$_LANG['login_faild'] = 'Incorrect user name or password';
$_LANG['forget_faild'] = 'Incorrect user name or mailbox';
$_LANG['email_format_faild'] = 'Electronic mail format is incorrect';
$_LANG['captcha_error'] = 'The authentication code you entered is incorrect';
$_LANG['send_email_error'] = 'Email sending error，Please contact the administrator';
...
$_LANG['ecs_version'] = 'ECTouch version:';
...
//-- About us
/* ------------------------------------------------------ */
$_LANG['about_us'] = 'about ECTouch';
$_LANG['team_member'] = 'team member';
$_LANG['before_team_member'] = 'ECTouch Contributor';
...
$_LANG['edit_password_succeed'] = 'You have successfully modified the password，So you have to log in again!';
$_LANG['user_name_exist'] = 'The administrator already exists!';
$_LANG['email_exist'] = 'Email address already exists!';
$_LANG['captcha_error'] = 'The authentication code you entered is incorrect。';
$_LANG['login_faild'] = 'Your account information is incorrect。';
$_LANG['login_disable'] = 'The account you entered is temporarily unavailable。';
$_LANG['user_name_drop'] = 'Has been successfully deleted!';
$_LANG['pwd_error'] = 'Enter the old password error!';
$_LANG['old_password_empty'] = 'If you want to change a password,Must enter your old password.!';
$_LANG['edit_admininfo_error'] = 'Can only edit their own personal information!';
$_LANG['edit_admininfo_cannot'] = 'You can\'t do any of the permissions for this administrator!';
$_LANG['edit_remove_cannot'] = 'You can\'t delete this administrator demo!';
$_LANG['remove_self_cannot'] = 'You can\'t delete yourself!';
$_LANG['remove_cannot'] = 'This administrator can\'t delete the operation!';
$_LANG['password_error'] = 'The two input must be consistent';
$_LANG['modif_info'] = 'Edit personal data';
$_LANG['edit_navi'] = 'Set personal navigation';

$_LANG['password_notic'] = 'If you want to change a password,Please fill out the old password first,Such as blank,Password remain unchanged';
$_LANG['email_notic'] = 'Enter the administrator\'s Email mailbox,Must be Email format';
$_LANG['confirm_notic'] = 'Enter a password for the administrator\'s confirmation.,The two input must be consistent';
...
/* Site authorization */
$_LANG['empower'] = 'Site authorization';
?>