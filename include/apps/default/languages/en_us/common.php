 ...
 * ----------------------------------------------------------------------------
 * Function description：common public language file
 * ----------------------------------------------------------------------------
...
$_LANG['article_detail'] = 'Article content';
$_LANG['piece'] = 'piece';

$_LANG['goods_category'] = "goods category";
$_LANG['menu'] = "menu";
$_LANG['goods_detail'] = "Goods details";
$_LANG['detail_intro'] = "Details intro";
$_LANG['order_detail'] = "Order details";
$_LANG['order_submit'] = "Order submission";
$_LANG['select_shipping_method'] = "Please choose the delivery method";
$_LANG['select_payment_method'] = "Please choose to pay the way";
$_LANG['check_out'] = "Immediate settlement";
$_LANG['show_favourable'] = "View promotions";
$_LANG['empty_shopping'] = "There's nothing about the shopping cart, go shopping.";
$_LANG['go_shopping'] = "Go shopping";
$_LANG['shopping_cart'] = "Shopping Cart";
$_LANG['total_number'] = "pieces of goods";
$_LANG['goods_price'] = "Total (excluding freight)";
$_LANG['favourable_mz'] = "present";
$_LANG['favourable_mj'] = "reduce";
$_LANG['favourable_zk'] = "Fold";
$_LANG['group_buy_act'] = "group";
$_LANG['snatch_act'] = "snatch";
$_LANG['auction_act'] = "Auction";

/* 分类展示页  */
$_LANG['sort_default'] = 'The default';
$_LANG['sort_sales'] = 'Sales volume';
$_LANG['sort_popularity'] = 'Popularity';
$_LANG['sort_price'] = 'price';
$_LANG['like_num'] = 'people like';
$_LANG['scan_num'] = ' view';
$_LANG['button_submit'] = 'confirm';
$_LANG['clear_filter'] = 'clear';
...
$_LANG['art_no_keywords'] = "Enter article keyword search!";
/* 分页排序 */
...
$_LANG['five_stars'] = 'Very nice';
$_LANG['four_stars'] = 'Very good';
$_LANG['three_stars'] = 'General';
$_LANG['two_stars'] = 'No way';
$_LANG['one_stars'] = 'Poor';

$_LANG['all_comment'] = 'All';
$_LANG['favorable_comment'] = 'Praise';
$_LANG['medium_comment'] = 'In the comments';
$_LANG['bad_comment'] = 'Bad';
/* 其他信息 */
...
$_LANG['no_use_bonus'] = 'not Use bonus';
...
$_LANG['please_invoice_title'] = 'Please enter the invoice title';
$_LANG['invoice_content'] = 'Invoice content';
$_LANG['order_postscript'] = 'Order postscript';
$_LANG['please_order_postscript'] = 'Please enter the order postscript';
...
$_LANG['order_payed_sms'] = 'the orde %s has already paid，Consignee：%s Phone：%s';
...
$_LANG['comment_num'] = ' people evaluation';
...
$_LANG['exchange_num'] = 'Exchange rate';
...
$_LANG['wholesale_goods_info'] = 'Wholesale Goods';
...
$_LANG['log_action']['remove'] = 'remove';
...
$_LANG['log_action']['trash'] = 'trash';
$_LANG['log_action']['restore'] = 'restore';
$_LANG['log_action']['batch_trash'] = 'batch trash';
...
$_LANG['log_action']['favourable'] = 'Preferential activity';
...
$_LANG['log_action']['ads_position'] = 'Ad position';
$_LANG['log_action']['ads'] = 'ads';
$_LANG['log_action']['area'] = 'area';

$_LANG['log_action']['group_buy'] = 'groupbuy goods';
$_LANG['log_action']['goods_type'] = 'Goods type';
$_LANG['log_action']['booking'] = 'booking management';
$_LANG['log_action']['tag_manage'] = 'Tag management';
$_LANG['log_action']['shop_config'] = 'Store settings';
$_LANG['log_action']['languages'] = 'Foreground language';
$_LANG['log_action']['user_surplus'] = 'Member balance';
$_LANG['log_action']['message'] = 'Member message';
$_LANG['log_action']['fckfile'] = 'FCK files';

$_LANG['log_action']['db_backup'] = 'Database backup';
$_LANG['log_action']['package'] = 'Value package';
$_LANG['log_action']['exchange_goods'] = 'Integral convertibility of the goods';
...
$_LANG['flow_login_register']['username_invalid'] = 'You entered an invalid username.';
$_LANG['flow_login_register']['password_not_null'] = 'Please enter your password.';
$_LANG['flow_login_register']['email_not_null'] = 'Please enter your email.';
$_LANG['flow_login_register']['email_invalid'] = 'Your email is incorrect.';
$_LANG['flow_login_register']['password_not_same'] = 'The password you entered is inconsistent with the confirmation password.';
$_LANG['flow_login_register']['password_lt_six'] = 'The password can\'t be less than 6 characters.';

$_LANG['regist_success'] = "Congratulations, %s Account registration success!";
$_LANG['login_success'] = 'Congratulations! You have successfully landed this site!';

/* 购物车 */
$_LANG['buy_now'] = 'Purchase immediately';
$_LANG['update_cart'] = 'Updating shopping cart';
$_LANG['back_to_cart'] = 'Back shopping cart';
$_LANG['update_cart_notice'] = 'Shopping cart update successfully, please re choose the gifts you need.';
$_LANG['direct_shopping'] = 'Direct purchase';
$_LANG['goods_not_exists'] = 'I\'m sorry, the specified product does not exist.';
$_LANG['drop_goods_confirm'] = 'Are you sure you want to move the product out of the shopping cart?';
$_LANG['goods_number_not_int'] = 'Please enter the right number of goods.';
$_LANG['stock_insufficiency'] = 'I\'m sorry, the goods you choose %s The number of stocks only %d，You can only buy %d pieces of 。';
$_LANG['package_stock_insufficiency'] = 'Sorry, the number you choose value package beyond inventory. Please reduce your purchases or contact the merchant.';
$_LANG['shopping_flow'] = 'Shopping process';
$_LANG['username_exists'] = 'Your user name already exists, please change it for a try..';
$_LANG['email_exists'] = 'Your email has been there, please try it for a try..';
$_LANG['surplus_not_enough'] = 'The balance you use cannot exceed your current balance.';
$_LANG['integral_not_enough'] = 'You can\'t use the integral over your existing points.';
$_LANG['integral_too_much'] = "You can\'t exceed the points you use%d";
$_LANG['invalid_bonus'] = "You choose a red envelope does not exist.";
$_LANG['no_goods_in_cart'] = 'There\'s no product in your shopping cart.!';
$_LANG['not_submit_order'] = 'You are involved in the purchase of this order has been submitted, do not repeat the operation!';
$_LANG['pay_success'] = 'The payment has been successful, we will ship as soon as possible for you.';
$_LANG['pay_fail'] = 'The payment failed, please contact us in time.';
$_LANG['pay_disabled'] = 'The payment method you choose has been deactivated.';
$_LANG['pay_invalid'] = 'You chose an invalid payment method.. The mode of payment does not exist or has been deactivated. Please contact us immediately.';
$_LANG['flow_no_shipping'] = 'You must choose a delivery mode.';
$_LANG['flow_no_payment'] = 'You must choose a payment method.';
$_LANG['pay_not_exist'] = 'The choice of payment does not exist.';
$_LANG['storage_short'] = 'Insufficient inventory';
$_LANG['subtotal'] = 'Subtotal';
$_LANG['accessories'] = 'Accessories';
$_LANG['largess'] = 'Gift';
$_LANG['shopping_money'] = 'The amount of total shopping %s';
$_LANG['than_market_price'] = 'Than the market price %s of %s (%s)';
$_LANG['your_discount'] = 'According to preferential activities<a href="'.url('activity/index').'"><font color=red>%s</font></a>You can enjoy the discount %s';
$_LANG['no'] = 'no';
$_LANG['not_support_virtual_goods'] = 'There are non entity goods in the shopping cart,Anonymous purchase,Please purchase after landing';
$_LANG['not_support_insure'] = 'Do not support the price';
$_LANG['clear_cart'] = 'Empty shopping cart';
$_LANG['drop_to_collect'] = 'add to collect';
$_LANG['password_js']['show_div_text'] = 'Please click the update cart button';
$_LANG['password_js']['show_div_exit'] = 'close';
$_LANG['goods_fittings'] = 'Commodity related accessories';
$_LANG['parent_name'] = 'Related commodities:';
...
$_LANG['flow_js']['mobile_not_null'] = 'Mobile phone number can not be empty';
...
$_LANG['change_payment'] = 'Or replace the payment method';
...
$_LANG['back_home'] = '<a href="'.url('index/index').'">Back to home</a>';
$_LANG['goto_user_center'] = '<a href="'.url('user/index').'">Member center</a>';
...
$_LANG['order_effective'] = 'The order has come into effect';
