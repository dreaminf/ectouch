...
return array(
	...
	'APP' => array(
		...
		'LOG_PATH' => ROOT_PATH . 'data/attached/log/', // 出错信息存放的目录，出错信息以天为单位存放，一般不需要修改
		...
		'HTML_CACHE_PATH' => ROOT_PATH . 'data/attached/html_cache/', // 静态页面缓存目录，一般不需要修改
	...
	'TPL' => array(
		...
		/* 普通文件缓存 */
		'TPL_CACHE_PATH' => ROOT_PATH . 'data/attached/tpl_cache/', // 模板缓存目录，一般不需要修改
