...
require_once('PinYint/Segment/Segment.class.php');
class PinYint {
    ...
    public static function init(){
        if(empty(self::$_PINYIN_DICT)){
            self::$_PINYIN_DICT = include 'PinYint/dict/dict-zi.php';
        }
        if(empty(self::$_PHONETIC_SYMBOL)){
            self::$_PHONETIC_SYMBOL = include 'PinYint/dict/phonetic-symbol.php';
    ...
    public static function phrases_pinyin($phrases, $style){
        if(empty(self::$_PHRASES_DICT)){
            self::$_PHRASES_DICT = include 'PinYint/dict/phrases-dict.php';
        }
        $py = array();
