...
use app\api\models\v1\GoodsCategory;
use app\api\models\v1\Goods;
use app\api\models\v1\Comment;
use app\api\models\v1\CollectGoods;
use app\api\models\v1\Products;
use yii\data\Pagination;
use Yii;

class GoodsCategoryRepository extends FoundationRepository{
    ...
    public static function getList(array $attributes)
    {
        ...
        return self::formatBody(['categories' => $data,'paged' => self::formatPaged($page, $page_size, $total)]);
    ...
    {
        return $this->belongsTo('app\api\models\v1\GoodsCategory', 'parent_id', 'id');
    }

    public function categories()
    {
        return $this->hasMany('app\api\models\v1\GoodsCategory', 'parent_id', 'id');
    }
}